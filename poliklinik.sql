...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Des 2023 pada 09.27
...
(1451, 'Diapet', 'Botol', 150000),
(1452, 'Sirplus', 'Botol', 45000);
...
(4, 'pasien', 'pasien123', 'pasien'),
(7, 'dokter', 'dokter123', 'dokter'),
(10, 'atha', 'qwerty123', 'admin');
...
ALTER TABLE `periksa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_id_periksa` (`id_daftar_poli`);
...
--
ALTER TABLE `daftar_poli`
  ADD CONSTRAINT `fk_id_jp` FOREIGN KEY (`id_jadwal`) REFERENCES `jadwal_periksa` (`id`),
...
--
ALTER TABLE `detail_periksa`
  ADD CONSTRAINT `fk_id_dp` FOREIGN KEY (`id_periksa`) REFERENCES `periksa` (`id`),
...
--
ALTER TABLE `periksa`
  ADD CONSTRAINT `fk_id_periksa` FOREIGN KEY (`id_daftar_poli`) REFERENCES `daftar_poli` (`id`);
COMMIT;
